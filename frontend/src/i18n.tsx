...
const STRINGS: Record<string, { de: string; en: string }> = {
  ...
  setup_install_rename_defaults: {
    de: 'Vordefinierte Rename-Einstellungen installieren (Separatoren- und Scene-Tag-Filter + Standardregel)',
    en: 'Install pre-defined rename settings (separator & scene tag filters + default rule)',
  },
  ...
  ren_strip_filters_subtitle: {
    de: 'Wiederverwendbare Filter, die im Filename-Segment einer Rename-Regel angewendet werden können.',
    en: 'Reusable filters that can be applied in the filename segment of a rename rule.',
  },
  ren_strip_filter_new: { de: 'Neuer Filter', en: 'New filter' },
  ren_strip_filter_edit: { de: 'Bearbeiten', en: 'Edit' },
  ren_strip_filter_delete: { de: 'Löschen', en: 'Delete' },
  ren_strip_filter_delete_confirm: {
    de: 'Filter wirklich löschen?',
    en: 'Delete this filter?',
  },
  ren_strip_filter_none: { de: 'Noch keine Strip-Filter angelegt.', en: 'No strip filters yet.' },
  ren_strip_filter_name: { de: 'Name', en: 'Name' },
  ren_strip_filter_type: { de: 'Typ', en: 'Type' },
  ren_strip_filter_type_strings: { de: 'Wörter/Tags entfernen', en: 'Remove words/tags' },
  ren_strip_filter_type_replace_chars: { de: 'Zeichen ersetzen', en: 'Replace characters' },
  ren_strip_filter_replace_from: { de: 'Von', en: 'From' },
  ren_strip_filter_replace_to: { de: 'Nach', en: 'To' },
  ren_strip_filter_add_pair: { de: 'Paar hinzufügen', en: 'Add pair' },
  ren_strip_filter_entries: { de: 'Einträge (einer pro Zeile)', en: 'Entries (one per line)' },
